...
point = Point(3,3)
print(line.middlePoint(point))

line = Line.fromCoord(2.91,7.98,0.24,-0.64)
point = Point(-7.25,1.81)
print(line.middlePoint(point))

line = Line.fromCoord(13.20,-4.98,12.29,-5.71)
point = Point(-9.91,5.42)
print(line.middlePoint(point))
