...
point = Point(2,2)
parallel = line.parallelLine(point)
parallel.normalize()
print(parallel)

line = Line.fromCoord(-4.97,-7.93,-0.09,-1.52)
point = Point(-14.01,-10.61)
parallel = line.parallelLine(point)
parallel.normalize()
print(parallel)

line = Line.fromCoord(14.45,13.39,0.05,14.75)
point = Point(0.85,7.32)
parallel = line.parallelLine(point)
parallel.normalize()
print(parallel)

line = Line.fromCoord(-13.33,-5.13,14.38,5.37)
point = Point(5.38,1.86)
parallel = line.parallelLine(point)
parallel.normalize()
print(parallel)
